...
logging.basicConfig(filename='answer_fusion_sum_t5_base_miracle_esp.log',
                        filemode='a',
...
import json
with open('./corpus_miracl_es.json', 'w') as f:
...
with open('./results_bm25_miracl_es.json', 'w') as f:
